...
class StorageService:
    def __init__(self):
        try:
            ...
            logger.info(f"StorageService connected to MinIO endpoint '{settings.MINIO_ENDPOINT}'")
    ...
    def upload_file(self, file: UploadFile) -> str:
        ...
        try:
            ...
            logger.info(f"Successfully uploaded '{file.filename}'. Public URL: {public_url}")
            return public_url
