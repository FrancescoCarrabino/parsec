...
class SlideDesigner(Agent):
            ...
            Tool(
                function={
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "slide_title_for_layer_panel": {
                                "type": "string",
                                "description": "A descriptive name for the slide, e.g., 'Title Slide' or 'Q3 Results'.",
                            }
                        },
                ...
                function={
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "frame_id": {
                                "type": "string",
                                "description": "The ID of the slide frame to place the text on.",
                            },
                            "text": {
                                "type": "string",
                            ...
                            "role": {
                                ...
                                "description": "The semantic role of the text, which determines its styling and placement.",
                            },
                        },
                ...
                function={
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "frame_id": {
                                "type": "string",
                                "description": "The ID of the slide frame to place the image on.",
                            },
                            "image_url": {
                                "type": "string",
                            ...
                            "alt_text": {
                                "type": "string",
                                "description": "A descriptive alt text for the image.",
                            },
                        },
        ...
        try:
            ...
            for _ in range(5):  # Max 5 steps to prevent infinite loops
                ...
                for tool_call in response_message.tool_calls:
                    ...
                    logger.info(
                        f"SlideDesigner is calling tool '{tool_name}' with args: {tool_args}"
                    )
    ...
    async def _create_slide_frame(
        self, context: dict, slide_title_for_layer_panel: str
    ) -> dict:
        ...
        payload = {
            "id": frame_id,
            "element_type": "frame",
            "name": slide_title_for_layer_panel,
            "x": x,
            "y": y,
            "width": 1920,
            "height": 1080,
        ...
        element = self._workspace.create_element_from_payload(
            payload
        )  # This adds to workspace but doesn't commit history
        self._workspace.update_presentation_order(
            {"action": "add", "frame_id": frame_id}
        )  # Make it a slide
    ...
    async def _create_text_element(
        self, context: dict, frame_id: str, text: str, role: str
    ) -> dict:
    ...
    async def _create_image_element(
        self, context: dict, frame_id: str, image_url: str, alt_text: str
    ) -> dict:
        """
        ...
        if not element:
            error_msg = (
                f"Workspace failed to create image element with payload: {payload}"
            )
