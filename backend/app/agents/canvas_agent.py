...
class CanvasAgent(Agent):
        ...
        return [
            ...
            Tool(function={
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "height": {"type": "number", "description": "The height of the shape."},
                        "fill_color": {"type": "string", "description": "Hex color code for the fill (e.g., '#FFFFFF')."},
                        "stroke_color": {"type": "string", "description": "Optional: Hex color code for the border."},
                        "stroke_width": {"type": "number", "description": "Optional: Width of the border."},
                        "corner_radius": {"type": "number", "description": "Optional: Radius for rounded corners (for rectangles)."},
                        "parentId": {"type": "string", "description": "Optional: The ID of a parent frame to place this shape inside."}
                    },
                    "required": ["shape_type", "x", "y", "width", "height", "fill_color"]
                }
            }),
            Tool(function={
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "content": {"type": "string", "description": "The text content of the element."},
                        "x": {"type": "number"}, "y": {"type": "number"},
                        "width": {"type": "number"}, "height": {"type": "number"},
                        "fontSize": {"type": "number", "description": "Font size in pixels."},
                        "fontColor": {"type": "string", "description": "Hex color code for the text."},
                        ...
                        "parentId": {"type": "string", "description": "Optional: The ID of a parent frame to place this text inside."}
                    },
            ...
            Tool(function={
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "x": {"type": "number"}, "y": {"type": "number"},
                        "width": {"type": "number"}, "height": {"type": "number"},
                        "alt_text": {"type": "string", "description": "Alternative text for the image."},
                        "parentId": {"type": "string", "description": "Optional: The ID of a parent frame to place this image inside."}
                    },
            ...
            Tool(function={
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "A descriptive name for the frame (e.g., 'Sidebar', 'Main Content')."},
                        "x": {"type": "number"}, "y": {"type": "number"},
                        "width": {"type": "number"}, "height": {"type": "number"},
                        "fill_color": {"type": "string", "description": "Optional: Background color of the frame."},
                        "stroke_color": {"type": "string", "description": "Optional: Border color of the frame."},
                        "stroke_width": {"type": "number", "description": "Optional: Border width."},
                        "corner_radius": {"type": "number", "description": "Optional: Radius for rounded corners."},
                        "parentId": {"type": "string", "description": "Optional: ID of a parent frame to place this frame within."},
                    },
            ...
            Tool(function={
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "parent_frame_id": {"type": "string", "description": "The ID of the main frame to place the header within."},
                        "height": {"type": "number", "description": "The height of the header bar."},
                        "logo_text": {"type": "string", "description": "The text for the logo (e.g., 'Parsec')."},
                        "nav_links": {"type": "array", "items": {"type": "string"}, "description": "List of navigation link texts (e.g., ['Dashboard', 'Analytics'])."}
                    },
                    "required": ["parent_frame_id", "height", "logo_text", "nav_links"]
                }
            }),
            Tool(function={
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "parent_frame_id": {"type": "string", "description": "The ID of the main frame to place the sidebar within."},
                        "width": {"type": "number", "description": "The width of the sidebar."},
                        "position": {"type": "string", "enum": ["left", "right"], "description": "Position of the sidebar ('left' or 'right')."},
                        "nav_items": {"type": "array", "items": {"type": "string"}, "description": "List of navigation item texts (e.g., ['Home', 'Profile', 'Settings'])."}
                    },
                    "required": ["parent_frame_id", "width", "position", "nav_items"]
                }
            }),
            Tool(function={
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "parent_frame_id": {"type": "string", "description": "The ID of the frame to place the card within."},
                        "x": {"type": "number"}, "y": {"type": "number"},
                        "width": {"type": "number"}, "height": {"type": "number"},
                        "title": {"type": "string", "description": "Main title of the card."},
                        "value": {"type": "string", "description": "Primary value or metric on the card."},
                        "subtitle": {"type": "string", "description": "Optional: secondary value or unit."}
                    },
                    "required": ["parent_frame_id", "x", "y", "width", "height", "title", "value"]
                }
            }),
    ...
    async def run_task(
        ...
        **Contextual Information:**
        ...
        try:
            ...
            for i in range(3): # Limit to 3 steps to prevent infinite loops (e.g., invoke -> create -> finish)
                await send_status_update("THINKING", f"CanvasAgent thinking (step {i+1})...", {"agent_name": self.name})
                response = await litellm.acompletion(
                    model=settings.LITELLM_TEXT_MODEL, messages=messages,
                    tools=[t.model_dump() for t in self.tools], tool_choice="auto", temperature=0.0,
                ...
                messages.append(response_message) # Add AI response to conversation history

                for tool_call in response_message.tool_calls:
                    tool_name = tool_call.function.name
                    tool_args = json.loads(tool_call.function.arguments)
                    
                    await send_status_update("INVOKING_TOOL", f"CanvasAgent using tool: {tool_name}...", {"target_tool": tool_name})
                    logger.info(f"CanvasAgent is calling tool '{tool_name}' with args: {tool_args}")
                    
                    tool_result = {"status": "failed", "error": "Tool execution failed or returned unexpected result."} # Default failure
                    if tool_name == "invoke_agent":
                        ...
                        if tool_function:
                            ...
                            logger.error(f"Tool '{tool_name}' is defined but not implemented in available_functions.")
                            tool_result = {"status": "failed", "error": f"Internal error: Tool '{tool_name}' is not implemented."}
            ...
            return {"status": "failed", "error": f"An error occurred during canvas operation: {str(e)}"}

    # --- Tool Implementations ---
    # These methods interact with the WorkspaceService to create/update elements.
    # They append commands to the shared context.
    
    async def _create_shape(self, context: dict, shape_type: str, x: float, y: float, width: float, height: float, fill_color: str, parentId: str = None, stroke_color: str = None, stroke_width: float = 1, corner_radius: float = 0) -> dict:
        payload = {
            "element_type": "shape", "shape_type": shape_type,
        ...
        if not element: return {"status": "failed", "error": "Workspace failed to create shape element."}
        context["commands"].append({"type": "ELEMENT_CREATED", "payload": element.model_dump()})
        return {"element_id": element.id, "status": "success"}

    async def _create_text_element(self, context: dict, content: str, x: float, y: float, width: float, height: float, parentId: str = None, fontSize: int = 16, fontColor: str = "#DDDDDD", fontWeight: int = 400, textAlign: str = "left") -> dict:
        payload = {
    ...
    async def _create_image_element(self, context: dict, image_url: str, alt_text: str, x: float, y: float, width: float, height: float, parentId: str = None) -> dict:
        payload = {
    ...
    async def _create_frame(self, context: dict, name: str, x: float, y: float, width: float, height: float, fill_color: str = "rgba(255, 255, 255, 0.05)", stroke_color: str = "#444444", stroke_width: float = 1, corner_radius: float = 0, parentId: str = None) -> dict:
        payload = {
            "element_type": "frame", "name": name,
            "x": x, "y": y, "width": width, "height": height,
            "fill": {"type": "solid", "color": fill_color},
        ...
        element = self._workspace.create_element_from_payload(payload)
        if not element: return {"status": "failed", "error": "Workspace failed to create frame."}
        context["commands"].append({"type": "ELEMENT_CREATED", "payload": element.model_dump()})
        return {"element_id": element.id, "status": "success"}

    async def _create_header_bar(self, context: dict, parent_frame_id: str, height: float, logo_text: str, nav_links: List[str]) -> dict:
        frame = self._workspace.elements.get(parent_frame_id)
        if not frame: return {"status": "failed", "error": f"Parent frame {parent_frame_id} not found for header."}

        header_elements_payloads = []
        # Background rectangle for the header
        header_elements_payloads.append({
            "element_type": "shape", "shape_type": "rect", "parentId": parent_frame_id,
            "x": 0, "y": 0, "width": frame.width, "height": height,
            "fill": {"type": "solid", "color": "#222222"} # Use palette color
        })
        # Logo text
        header_elements_payloads.append({
            "element_type": "text", "parentId": parent_frame_id,
            "content": logo_text, "x": 20, "y": height / 2 - 12, "width": 150, "height": 24,
            "fontSize": 20, "fontWeight": 700, "fontColor": "#007AFF" # Accent color
        })
        # Navigation links
        ...
        for link_text in nav_links:
            header_elements_payloads.append({
                "element_type": "text", "parentId": parent_frame_id,
                "content": link_text, "x": current_x, "y": height / 2 - 8, "width": 80, "height": 16,
                "fontSize": 14, "fontColor": "#B0B0B0", "textAlign": "center"
            })
            current_x += 100 # Spacing between links
        
        elements = self._workspace.create_elements_batch(header_elements_payloads)
        if not elements: return {"status": "failed", "error": "Workspace failed to create header elements."}
        for el in elements: context["commands"].append({"type": "ELEMENT_CREATED", "payload": el.model_dump()})
        return {"status": "success", "created_element_ids": [el.id for el in elements]}

    async def _create_sidebar_layout(self, context: dict, parent_frame_id: str, width: float, position: Literal["left", "right"], nav_items: List[str]) -> dict:
        frame = self._workspace.elements.get(parent_frame_id)
        if not frame: return {"status": "failed", "error": f"Parent frame {parent_frame_id} not found for sidebar."}
        ...
        sidebar_elements_payloads.append({
            "element_type": "shape", "shape_type": "rect", "parentId": parent_frame_id,
            "x": sidebar_x, "y": 0, "width": width, "height": frame.height,
        ...
        for item_text in nav_items:
            sidebar_elements_payloads.append({
                "element_type": "text", "parentId": parent_frame_id,
                "content": item_text, "x": sidebar_x + 20, "y": current_y, "width": width - 40, "height": 24,
                "fontSize": 16, "fontColor": "#FFFFFF", "fontWeight": 400
            })
            current_y += 40 # Spacing between items
        
        elements = self._workspace.create_elements_batch(sidebar_elements_payloads)
        if not elements: return {"status": "failed", "error": "Workspace failed to create sidebar elements."}
        for el in elements: context["commands"].append({"type": "ELEMENT_CREATED", "payload": el.model_dump()})
        return {"status": "success", "created_element_ids": [el.id for el in elements]}

    async def _create_data_card(self, context: dict, parent_frame_id: str, x: float, y: float, width: float, height: float, title: str, value: str, subtitle: str = None) -> dict:
        ...
        card_elements_payloads.append({
            "element_type": "text", "parentId": parent_frame_id,
            "content": title, "x": x + 20, "y": y + 20, "width": width - 40, "height": 20,
            "fontSize": 16, "fontColor": "#B0B0B0"
        })
        # Value
        card_elements_payloads.append({
            "element_type": "text", "parentId": parent_frame_id,
            "content": value, "x": x + 20, "y": y + 45, "width": width - 40, "height": 30,
            "fontSize": 28, "fontWeight": 700, "fontColor": "#FFFFFF"
        })
        # Subtitle
        if subtitle:
            card_elements_payloads.append({
                "element_type": "text", "parentId": parent_frame_id,
                "content": subtitle, "x": x + 20, "y": y + 80, "width": width - 40, "height": 16,
                "fontSize": 14, "fontColor": "#888888"
            })

        elements = self._workspace.create_elements_batch(card_elements_payloads)
        if not elements: return {"status": "failed", "error": "Workspace failed to create data card elements."}
        for el in elements: context["commands"].append({"type": "ELEMENT_CREATED", "payload": el.model_dump()})
        return {"status": "success", "created_element_ids": [el.id for el in elements]}